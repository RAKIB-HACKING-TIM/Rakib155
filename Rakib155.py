...
\033[38;5;196m[\x1b[38;5;46m•\033[38;5;196m]\x1b[38;5;46m VERSION  :.0.1
...
class Main:
    def __init__(self):
        ...
        if niloy in ["1", "01"]:
            v1()
        if niloy in ["2","02"]:
            os.system('am start https://www.facebook.com/profile.php?id=100088562019366');time.sleep(5);Main()
        if niloy in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[38;5;196m[\x1b[38;5;46mRAKIB-OK\033[38;5;196m] \x1b[38;5;46m%s\033[38;5;196m | \x1b[38;5;46mOK\033[38;5;196m:\x1b[38;5;46m%s '%(loop,len(ok))),
            sys.stdout.flush()
